    ...
    def __init__(self, navegador=None):
        ...
        self.adicionar_componente(
            TextoFormatado(
                ...
                fonte_nome=Fontes.segoe_ui_emoji(), centralizado=True
            )
        )
        self.adicionar_componente(
            TextoFormatado(
        ...
        self.adicionar_componente(
            Botao(
                ...
                fonte=Fontes.segoe_ui_emoji(), tamanho_fonte=28, raio_borda=16
            )
        )
        ...
        self.adicionar_componente(
            Botao(
                ...
                fonte=Fontes.segoe_ui_emoji(), tamanho_fonte=20, raio_borda=10
            )
        )