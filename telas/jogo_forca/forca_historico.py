...
class TelaHistoricoForca(Tela):
    def __init__(self, navegador=None):
        super().__init__(
            largura=600, altura=400, titulo="Histórico Forca",
            cor_fundo=Cores.preto(), navegador=navegador
        )
        self.navegador = navegador
        self.adicionar_componente(TextoFormatado(
            x=300, y=40, texto="HISTÓRICO FORCA", tamanho=38, cor_texto=Cores.verde(),
    ...
    def carregar_historico(self):
        ...
        historico = ForcaDB.historico() or []
